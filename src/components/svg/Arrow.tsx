...
export default function Arrow({height, width, color, hoverStyle, defaultRotation = "rotate-0", activeRotation, active} : {height: number; width: number; color: string; hoverStyle?: string; defaultRotation: string; activeRotation: string; active: boolean;}) : ReactElement {
    ...
    return (
        <svg width={width} height={height} viewBox="0 0 10 10" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg" className={style}>
