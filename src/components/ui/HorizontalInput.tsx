...
export default function HorizontalInput({ label, colSpan, hasToBeProportional, defaultValue, fixedValue, value: controlledValue, disabled, fieldId, readOnly, isError, errorMessage, setErrors, onValueChange, inputType = 'text', inputStep }: { label: string, colSpan?: string, hasToBeProportional: boolean, defaultValue?: string, fixedValue?: string, value?: string, disabled?: boolean, fieldId: string, readOnly?: boolean, isError: boolean, errorMessage: string | null, setErrors: () => void, onValueChange?: (val: string) => void, inputType?: 'text' | 'number', inputStep?: string }) : React.ReactElement {
